...
using System;
using UnityEngine;
using Cybershoes; //added by Cybershoes

/// <summary>
/// Controls the player's movement in virtual reality.
/// </summary>
[RequireComponent(typeof(CharacterController))]
public class CybershoesOVRPlayerController : MonoBehaviour
{
	/// <summary>
	...
	private CybershoesHeightScaler cybershoesScaler; // added by Cybershoes
	...
	void Start()
	{
		...
		cybershoesScaler = GameObject.Find("CybershoesManager").GetComponent<CybershoesHeightScaler>(); // added by Cybershoes
	}
	...
	protected virtual void UpdateController()
	{
		if (useProfileData)
		{
            ...
            p.y += cybershoesOffset; // added by Cybershoes
	...
	public virtual void UpdateMovement()
	{
		...
		if (EnableLinearMovement)
		{
			...
			Vector2 primaryAxis = OVRInput.Get(OVRInput.Axis2D.PrimaryThumbstick, OVRInput.Controller.Touch); // added by Cybershoes
